...
1. **Version Bump**: Bump the patch version in `package.json` (e.g. `1.0.2` → `1.0.3`). Note: Do NOT bump package.json version if changes are made solely to the website/documentation (`site/`).
